...
public class CreateExpenseTests
{
    ...
    // ============================================================
    // 4) TOTAL DE FACTURAS NEGATIVO O CERO
    // ============================================================
    [Fact]
    ...
    public async Task ExecuteAsync_ShouldCreateExpenseSuccessfully()
    {
        ...
        _expenseRepositoryMock.Setup(
            x => x.AddExpenseAsync(It.IsAny<global::ForariaDomain.Expense>())
        )
        .ReturnsAsync((global::ForariaDomain.Expense e) =>
        {
        ...
        // Verificar que se actualizaron las facturas
        ...
        // Verificar que se guardó el Expense
