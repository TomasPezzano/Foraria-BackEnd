...
namespace ForariaTest.Unit.Suppliers
{
    public class GetSupplierByIdTests
    {
        ...
        [Fact]
        public async Task Execute_ExistingSupplier_ReturnsSupplier()
        {
            var supplierId = 1;
            ...
            var result = await _getSupplierById.Execute(supplierId);
        ...
        [Fact]
        public async Task Execute_NonExistingSupplier_ReturnsNull()
        {
            var supplierId = 999;
        ...
        [Fact]
        public async Task Execute_SupplierWithAllFields_ReturnsCompleteData()
        {
            var supplierId = 5;
        ...
        [Fact]
        public async Task Execute_InactiveSupplier_ReturnsSupplierWithActiveFalse()
        {
            var supplierId = 3;
        ...
        [Fact]
        public async Task Execute_SupplierWithNullOptionalFields_ReturnsSupplierSuccessfully()
        {
            var supplierId = 7;
        ...
        [InlineData(100)]
        [InlineData(9999)]
        public async Task Execute_DifferentSupplierIds_CallsRepositoryWithCorrectId(int supplierId)
        {
            var supplier = new Supplier
            {
                Id = supplierId,
