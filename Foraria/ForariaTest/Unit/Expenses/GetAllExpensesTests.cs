    ...
    public class GetAllExpensesTests
    {
        ...
        public async Task Execute_ShouldThrowInvalidOperation_WhenRepositoryReturnsNull()
        {
            _expenseRepoMock
                ...
                .ReturnsAsync((IEnumerable<ForariaDomain.Expense>)null);
        ...
        public async Task Execute_ShouldThrowKeyNotFound_WhenExpensesListIsEmpty()
        {
            _expenseRepoMock
                .Setup(x => x.GetAllExpenses())
                .ReturnsAsync(new List<ForariaDomain.Expense>());
        ...
        {
            var expenses = new List<ForariaDomain.Expense>
            {
                new ForariaDomain.Expense { Id = 1, TotalAmount = 500 },
                new ForariaDomain.Expense { Id = 2, TotalAmount = 1000 }
            };
