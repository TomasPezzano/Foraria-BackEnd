...
public class DeleteMessageTests
{
    ...
    {
        var message = new global::ForariaDomain.Message { Id = 10, User_id = 3 };
    ...
    {
        var message = new global::ForariaDomain.Message { Id = 10, User_id = 5 };
        var user = new User
        {
            Id = 1,
    ...
    public async Task ExecuteAsync_ShouldDoNothing_WhenMessageAlreadyDeleted()
    {
        ...
        _messageRepoMock.Verify(x => x.Update(It.IsAny<global::ForariaDomain.Message>()), Times.Never);
    }
    ...
    public async Task ExecuteAsync_ShouldDeleteMessage_WhenUserIsOwner()
    {
        ...
        _messageRepoMock.Setup(x => x.Update(It.IsAny<global::ForariaDomain.Message>()))
        ...
        _messageRepoMock.Verify(x => x.Update(It.Is<global::ForariaDomain.Message>(m => m.Id == 10)), Times.Once);
    }
