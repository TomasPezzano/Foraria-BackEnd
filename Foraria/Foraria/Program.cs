...
builder.Services.AddScoped<IFcmPushNotificationService, PushNotificationService>();
...
builder.Services.AddScoped<ISendCallNotification, SendCallNotification>();
builder.Services.AddScoped<ISendClaimNotification, SendClaimNotification>();
